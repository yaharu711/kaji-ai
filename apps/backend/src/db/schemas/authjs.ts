...
export type NewVerificationTokenRecord = typeof verificationTokens.$inferInsert;
export type AuthenticatorRecord = typeof authenticators.$inferSelect;
export type NewAuthenticatorRecord = typeof authenticators.$inferInsert;
